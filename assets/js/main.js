                ...
                <div class="flex flex-col justify-between w-full h-full bg-white p-5">
                    <div class="flex flex-col">
                        <div class="flex flex-col border-b border-purple-100">
                            ...
                            <p class="text-xs md:text-xs font-spline text-gray-500 pb-1.5">${forNoob.category}</p>
                        </div>
                        <p class="text-xs md:text-xs  text-gray-500 mt-4 sm:max-h-12 line-clamp">${forNoob.description}</p>
                    </div>
